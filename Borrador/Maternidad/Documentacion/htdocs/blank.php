         ...
         <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <hr class="sidebar-divider">
               ...
               <li class="nav-item active">
                  <a aria-controls="collapsePages" aria-expanded="true" class="nav-link" data-target="#collapsePages" data-toggle="collapse" href="#">
                  ...
                  <div aria-labelledby="headingPages" class="collapse show" data-parent="#accordionSidebar" id="collapsePages">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">
                           Login Screens:
                        </h6>
                        ...
                        <div aria-labelledby="messagesDropdown" class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in">
                           ...
                           <a class="dropdown-item d-flex align-items-center" href="#">
                              <div class="dropdown-list-image mr-3">
                                 <img alt="..." class="rounded-circle" src="img/undraw_profile_1.svg"/>
                           ...
                           <a class="dropdown-item d-flex align-items-center" href="#">
                              <div class="dropdown-list-image mr-3">
                                 <img alt="..." class="rounded-circle" src="img/undraw_profile_2.svg"/>
                           ...
                           <a class="dropdown-item d-flex align-items-center" href="#">
                              <div class="dropdown-list-image mr-3">
                                 <img alt="..." class="rounded-circle" src="img/undraw_profile_3.svg"/>
